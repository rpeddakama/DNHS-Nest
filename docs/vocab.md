...
|[Comparing Numbers]() | Two numbers can be compared by using double equals and doing Object1 == Object2; true is returned if true and otherwise, false. | if(x > 5){ System.out.println("X is greater than 5"); |
...
| [nested loops]() | Nested loops are when at least one loop is inside of another and they all run; for each time the outer loop runs, the inner completely runs for instance.| ![image](https://user-images.githubusercontent.com/55494721/150836421-c6f6e134-2ef7-4075-b8a7-20f3ef683c13.png)
 | 
| [Big O notation (Hash map, Binary Search, Single loop, Nested Loop)]() |Big 0 notations are algorithms. Hash maps contain keys and values and they are tables that maps the keys and values; simmilar to an array, it is a collection of data essentially. Binary search is a search algorithm that can sort an algorithm and find a specific item from it. A single loop is just a regular loop that occurs and runs whereas for loops are where multiple loops inside of each other.  | ![image](https://user-images.githubusercontent.com/55494721/150836288-008fd330-833a-4cd4-933d-74e2ad7c75b1.png)
 | 
